...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements NdfdXML {
 ...
 */
    ...
    public NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            NdfdXMLBindingStub _stub = new NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                NdfdXMLBindingStub _stub = new NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
